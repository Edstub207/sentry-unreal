...
- Bump Java SDK (Android) from v7.8.0 to v8.53.0 ([#500](https://github.com/Edstub207/sentry-unreal/pull/500))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8530)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.53.0)
