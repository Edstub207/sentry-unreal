...
- Bump Java SDK (Android) from v7.8.0 to v8.44.0 ([#470](https://github.com/Edstub207/sentry-unreal/pull/470))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8440)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.44.0)
