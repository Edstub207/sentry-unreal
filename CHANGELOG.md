...
- Bump Java SDK (Android) from v7.8.0 to v8.30.0 ([#397](https://github.com/Edstub207/sentry-unreal/pull/397))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8300)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.30.0)
