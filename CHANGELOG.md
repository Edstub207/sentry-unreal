...
- Bump Java SDK (Android) from v7.8.0 to v8.21.0 ([#354](https://github.com/Edstub207/sentry-unreal/pull/354))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8210)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.21.0)
