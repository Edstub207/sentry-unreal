...
- Bump Java SDK (Android) from v6.28.0 to v7.4.0 ([#179](https://github.com/Edstub207/sentry-unreal/pull/179))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#740)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.28.0...7.4.0)
