...
- Bump Java SDK (Android) from v7.8.0 to v8.33.0 ([#410](https://github.com/Edstub207/sentry-unreal/pull/410))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8330)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.33.0)
