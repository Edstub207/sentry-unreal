...
- Bump Java SDK (Android) from v7.8.0 to v8.36.0 ([#427](https://github.com/Edstub207/sentry-unreal/pull/427))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8360)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.36.0)
