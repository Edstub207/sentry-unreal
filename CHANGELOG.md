...
- Bump Native SDK from v0.6.0 to v0.6.2 ([#80](https://github.com/Edstub207/sentry-unreal/pull/80))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#062)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.6.0...0.6.2)
