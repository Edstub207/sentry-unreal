...
- Bump Java SDK (Android) from v7.8.0 to v8.44.1 ([#472](https://github.com/Edstub207/sentry-unreal/pull/472))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8441)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.44.1)
