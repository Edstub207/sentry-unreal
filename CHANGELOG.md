...
- Bump Java SDK (Android) from v7.8.0 to v8.17.0 ([#336](https://github.com/Edstub207/sentry-unreal/pull/336))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8170)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.17.0)
