...
- Bump Java SDK (Android) from v7.8.0 to v8.54.0 ([#504](https://github.com/Edstub207/sentry-unreal/pull/504))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8540)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.54.0)
