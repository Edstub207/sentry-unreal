...
- Bump Java SDK (Android) from v7.8.0 to v8.42.0 ([#456](https://github.com/Edstub207/sentry-unreal/pull/456))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8420)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.42.0)
