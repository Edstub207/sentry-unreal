...
- Bump Java SDK (Android) from v6.4.0 to v6.12.0 ([#43](https://github.com/Edstub207/sentry-unreal/pull/43))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#6120)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.4.0...6.12.0)
