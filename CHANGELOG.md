...
- Bump Java SDK (Android) from v7.8.0 to v8.11.0 ([#311](https://github.com/Edstub207/sentry-unreal/pull/311))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8110)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.11.0)
