...
- Bump Java SDK (Android) from v7.8.0 to v8.24.0 ([#371](https://github.com/Edstub207/sentry-unreal/pull/371))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8240)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.24.0)
