...
- Bump Java SDK (Android) from v7.8.0 to v8.27.0 ([#382](https://github.com/Edstub207/sentry-unreal/pull/382))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8270)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.27.0)
