...
- Bump Java SDK (Android) from v7.8.0 to v8.18.0 ([#341](https://github.com/Edstub207/sentry-unreal/pull/341))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8180)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.18.0)
