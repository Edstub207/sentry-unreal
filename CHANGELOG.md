...
- Bump Java SDK (Android) from v6.4.0 to v6.9.0 ([#31](https://github.com/Edstub207/sentry-unreal/pull/31))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#690)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.4.0...6.9.0)
