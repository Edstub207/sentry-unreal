...
- Bump Java SDK (Android) from v7.8.0 to v8.50.0 ([#490](https://github.com/Edstub207/sentry-unreal/pull/490))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8500)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.50.0)
