...
- Bump Cocoa SDK (iOS) from v8.10.0 to v8.17.0 ([#156](https://github.com/Edstub207/sentry-unreal/pull/156))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#8170)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.10.0...8.17.0)
