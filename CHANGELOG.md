...
- Bump Java SDK (Android) from v7.8.0 to v8.48.0 ([#482](https://github.com/Edstub207/sentry-unreal/pull/482))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8480)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.48.0)
