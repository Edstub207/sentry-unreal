...
- Bump Java SDK (Android) from v7.8.0 to v8.41.0 ([#450](https://github.com/Edstub207/sentry-unreal/pull/450))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8410)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.41.0)
