...
- Bump Java SDK (Android) from v7.8.0 to v8.29.0 ([#391](https://github.com/Edstub207/sentry-unreal/pull/391))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8290)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.29.0)
