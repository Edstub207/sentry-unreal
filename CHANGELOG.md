...
- Bump Java SDK (Android) from v7.8.0 to v8.8.0 ([#304](https://github.com/Edstub207/sentry-unreal/pull/304))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#880)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.8.0)
