...
- Bump Java SDK (Android) from v7.8.0 to v8.13.3 ([#328](https://github.com/Edstub207/sentry-unreal/pull/328))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8133)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.13.3)
