...
- Bump Java SDK (Android) from v6.28.0 to v6.32.0 ([#140](https://github.com/Edstub207/sentry-unreal/pull/140))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#6320)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.28.0...6.32.0)
