...
- Bump Java SDK (Android) from v7.8.0 to v8.39.1 ([#442](https://github.com/Edstub207/sentry-unreal/pull/442))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8391)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.39.1)
