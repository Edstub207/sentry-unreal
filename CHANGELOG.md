...
- Bump Java SDK (Android) from v7.8.0 to v8.15.0 ([#332](https://github.com/Edstub207/sentry-unreal/pull/332))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8150)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.15.0)
