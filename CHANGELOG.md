...
- Bump Java SDK (Android) from v7.8.0 to v8.40.0 ([#445](https://github.com/Edstub207/sentry-unreal/pull/445))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8400)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.40.0)
