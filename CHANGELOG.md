...
- Bump Java SDK (Android) from v7.8.0 to v8.5.0 ([#295](https://github.com/Edstub207/sentry-unreal/pull/295))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#850)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.5.0)
