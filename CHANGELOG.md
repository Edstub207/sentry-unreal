...
- Bump Java SDK (Android) from v7.8.0 to v8.4.0 ([#293](https://github.com/Edstub207/sentry-unreal/pull/293))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#840)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.4.0)
