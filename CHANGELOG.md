...
- Bump Java SDK (Android) from v7.8.0 to v8.23.0 ([#365](https://github.com/Edstub207/sentry-unreal/pull/365))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8230)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.23.0)
