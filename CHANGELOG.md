...
- Bump Java SDK (Android) from v7.8.0 to v8.13.1 ([#322](https://github.com/Edstub207/sentry-unreal/pull/322))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8131)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.13.1)
