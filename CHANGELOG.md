...
- Bump Java SDK (Android) from v7.8.0 to v8.10.0 ([#308](https://github.com/Edstub207/sentry-unreal/pull/308))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8100)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.10.0)
