...
- Bump Java SDK (Android) from v7.8.0 to v8.38.0 ([#438](https://github.com/Edstub207/sentry-unreal/pull/438))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8380)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.38.0)
