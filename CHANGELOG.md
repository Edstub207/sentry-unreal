...
- Bump Java SDK (Android) from v7.8.0 to v8.19.1 ([#347](https://github.com/Edstub207/sentry-unreal/pull/347))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8191)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.19.1)
