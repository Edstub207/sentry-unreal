...
- Bump Java SDK (Android) from v7.8.0 to v8.43.0 ([#459](https://github.com/Edstub207/sentry-unreal/pull/459))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8430)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.43.0)
