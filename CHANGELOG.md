...
- Bump Java SDK (Android) from v7.8.0 to v8.9.0 ([#307](https://github.com/Edstub207/sentry-unreal/pull/307))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#890)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.9.0)
