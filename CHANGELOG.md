...
- Bump Java SDK (Android) from v7.8.0 to v8.15.1 ([#333](https://github.com/Edstub207/sentry-unreal/pull/333))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8151)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.15.1)
