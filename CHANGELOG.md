...
- Bump Cocoa SDK (iOS) from v8.10.0 to v8.18.0 ([#164](https://github.com/Edstub207/sentry-unreal/pull/164))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#8180)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.10.0...8.18.0)
