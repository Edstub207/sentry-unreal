...
- Bump Java SDK (Android) from v6.4.0 to v6.10.0 ([#38](https://github.com/Edstub207/sentry-unreal/pull/38))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#6100)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.4.0...6.10.0)
