...
- Bump Java SDK (Android) from v7.8.0 to v8.51.0 ([#494](https://github.com/Edstub207/sentry-unreal/pull/494))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8510)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.51.0)
