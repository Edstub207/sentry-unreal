...
- Bump Java SDK (Android) from v7.8.0 to v8.35.0 ([#426](https://github.com/Edstub207/sentry-unreal/pull/426))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8350)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.35.0)
