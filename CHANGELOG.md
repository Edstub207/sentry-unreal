...
- Bump Java SDK (Android) from v7.8.0 to v8.19.0 ([#345](https://github.com/Edstub207/sentry-unreal/pull/345))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8190)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.19.0)
