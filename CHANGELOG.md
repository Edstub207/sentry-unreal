...
- Bump Java SDK (Android) from v7.8.0 to v8.34.1 ([#421](https://github.com/Edstub207/sentry-unreal/pull/421))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8341)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.34.1)
