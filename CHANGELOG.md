...
- Bump Java SDK (Android) from v6.28.0 to v7.1.0 ([#161](https://github.com/Edstub207/sentry-unreal/pull/161))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#710)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.28.0...7.1.0)
