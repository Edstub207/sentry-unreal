...
- Bump Java SDK (Android) from v7.8.0 to v8.46.0 ([#476](https://github.com/Edstub207/sentry-unreal/pull/476))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8460)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.46.0)
