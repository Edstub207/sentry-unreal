...
- Bump Java SDK (Android) from v7.8.0 to v8.26.0 ([#379](https://github.com/Edstub207/sentry-unreal/pull/379))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8260)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.26.0)
