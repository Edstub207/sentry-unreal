...
- Bump Java SDK (Android) from v6.4.0 to v6.7.0 ([#22](https://github.com/Edstub207/sentry-unreal/pull/22))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#670)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.4.0...6.7.0)
