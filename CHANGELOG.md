...
- Bump Java SDK (Android) from v6.28.0 to v7.5.0 ([#180](https://github.com/Edstub207/sentry-unreal/pull/180))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#750)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.28.0...7.5.0)
