...
- Bump Java SDK (Android) from v6.4.0 to v6.8.0 ([#30](https://github.com/Edstub207/sentry-unreal/pull/30))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#680)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.4.0...6.8.0)
