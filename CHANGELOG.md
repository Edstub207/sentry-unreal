...
- Bump Java SDK (Android) from v6.28.0 to v6.31.0 ([#138](https://github.com/Edstub207/sentry-unreal/pull/138))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#6310)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.28.0...6.31.0)
