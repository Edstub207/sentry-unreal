...
- Bump Java SDK (Android) from v6.4.0 to v6.11.0 ([#41](https://github.com/Edstub207/sentry-unreal/pull/41))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#6110)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.4.0...6.11.0)
