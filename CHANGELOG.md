...
- Bump Cocoa SDK (iOS) from v8.10.0 to v8.16.1 ([#153](https://github.com/Edstub207/sentry-unreal/pull/153))
  - [changelog](https://github.com/getsentry/sentry-cocoa/blob/main/CHANGELOG.md#8161)
  - [diff](https://github.com/getsentry/sentry-cocoa/compare/8.10.0...8.16.1)
