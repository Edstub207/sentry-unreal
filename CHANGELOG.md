...
- Bump Java SDK (Android) from v7.8.0 to v8.32.0 ([#406](https://github.com/Edstub207/sentry-unreal/pull/406))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8320)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.32.0)
