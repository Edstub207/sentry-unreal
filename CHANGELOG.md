...
- Bump Java SDK (Android) from v7.8.0 to v8.16.0 ([#334](https://github.com/Edstub207/sentry-unreal/pull/334))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8160)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.16.0)
