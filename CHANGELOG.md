...
- Bump Java SDK (Android) from v7.8.0 to v8.22.0 ([#359](https://github.com/Edstub207/sentry-unreal/pull/359))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8220)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.22.0)
