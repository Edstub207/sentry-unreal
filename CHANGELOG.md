...
- Bump Java SDK (Android) from v7.8.0 to v8.1.0 ([#280](https://github.com/Edstub207/sentry-unreal/pull/280))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#810)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.1.0)
