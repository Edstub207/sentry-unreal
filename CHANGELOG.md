...
- Bump Java SDK (Android) from v7.8.0 to v8.7.0 ([#302](https://github.com/Edstub207/sentry-unreal/pull/302))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#870)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.7.0)
