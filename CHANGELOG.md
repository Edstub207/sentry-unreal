...
- Bump Java SDK (Android) from v6.4.0 to v6.13.0 ([#45](https://github.com/Edstub207/sentry-unreal/pull/45))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#6130)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.4.0...6.13.0)
