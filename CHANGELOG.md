...
- Bump Java SDK (Android) from v7.8.0 to v8.12.0 ([#317](https://github.com/Edstub207/sentry-unreal/pull/317))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8120)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.12.0)
