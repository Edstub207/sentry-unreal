...
- Bump Java SDK (Android) from v7.8.0 to v8.25.0 ([#373](https://github.com/Edstub207/sentry-unreal/pull/373))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8250)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.25.0)
