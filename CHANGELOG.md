...
- Bump Java SDK (Android) from v7.8.0 to v8.37.0 ([#430](https://github.com/Edstub207/sentry-unreal/pull/430))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8370)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.37.0)
