...
- Bump Java SDK (Android) from v7.8.0 to v8.45.0 ([#474](https://github.com/Edstub207/sentry-unreal/pull/474))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8450)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.45.0)
