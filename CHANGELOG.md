...
- Bump Java SDK (Android) from v7.8.0 to v8.27.1 ([#383](https://github.com/Edstub207/sentry-unreal/pull/383))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8271)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.27.1)
