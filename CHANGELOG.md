...
- Bump Java SDK (Android) from v7.8.0 to v8.3.0 ([#288](https://github.com/Edstub207/sentry-unreal/pull/288))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#830)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.3.0)
