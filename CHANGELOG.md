...
- Bump Java SDK (Android) from v7.8.0 to v8.6.0 ([#301](https://github.com/Edstub207/sentry-unreal/pull/301))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#860)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.6.0)
