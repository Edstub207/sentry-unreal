...
- Bump Java SDK (Android) from v7.8.0 to v8.20.0 ([#350](https://github.com/Edstub207/sentry-unreal/pull/350))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8200)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.20.0)
