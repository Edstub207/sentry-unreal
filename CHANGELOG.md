...
- Bump Java SDK (Android) from v7.8.0 to v8.47.0 ([#479](https://github.com/Edstub207/sentry-unreal/pull/479))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8470)
  - [diff](https://github.com/getsentry/sentry-java/compare/7.8.0...8.47.0)
